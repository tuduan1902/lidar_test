...
const RearLidarMount REAR_LIDAR_MOUNTS[REAR_N_LIDAR] = {
    /* id=0 L0 thang sau    */ { 180.0f,  0.00f, -0.85f },
    /* id=1 L1 -22.5 do T   */ { 157.5f, -0.15f, -0.85f },
    /* id=2 L2 +22.5 do P   */ { 202.5f, +0.15f, -0.85f },
};
...
volatile uint8_t  g_dbg_sensor_data[REAR_N_LIDAR] = {0};
 ...
 * ============================================================ */
#define TX_QUEUE_SIZE   REAR_N_LIDAR
static uint8_t  s_queue_buf[TX_QUEUE_SIZE][REAR_PKT_LEN];
 ...
 * DEBUG LED MACROS
 * ============================================================ */
#ifdef REAR_DEBUG_LED_ENABLE
  #define LED_ON()     HAL_GPIO_WritePin(REAR_DEBUG_LED_PORT, REAR_DEBUG_LED_PIN, GPIO_PIN_SET)
  #define LED_OFF()    HAL_GPIO_WritePin(REAR_DEBUG_LED_PORT, REAR_DEBUG_LED_PIN, GPIO_PIN_RESET)
  #define LED_TOGGLE() HAL_GPIO_TogglePin(REAR_DEBUG_LED_PORT, REAR_DEBUG_LED_PIN)
#else
  #define LED_ON()
  #define LED_OFF()
  #define LED_TOGGLE()
...
static bool queue_flush_one(void) {
    ...
    memcpy(s_tx_buf, s_queue_buf[s_queue_tail], REAR_PKT_LEN);
