 ...
 *
 * Build:
 * g++ -std=c++17 -O2 -lpthread ./web/main_web_demo.cpp ./web/road_scanner.cpp -o lidar_demo
 * 
 * Check data for UART PORT on Jetson:
 * hexdump -C /dev/ttyTHS1 
 * 
 * Run:
 * ./lidar_demo /dev/ttyTHS1 /dev/ttyUSB0 /dev/ttyUSB1
 */
...
int main(int argc, char** argv) {
    ...
    road_scanner.on_pothole([&mgr](const RoadSample& sample) {
        ...
        float wy = (sample.dist_ema_m * 0.986f) + 0.8f;
